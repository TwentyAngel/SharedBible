document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function deleteTestimony(testimonyId) {
        ...
        try {
            ...
            if (result.success) {
                // Usamos una modal personalizada en lugar de alert()
    ...
    function renderSavedPublications(publications) {
        ...
        publications.forEach(post => {
            ...
            postCard.innerHTML = `
                ...
                <div class="post-body">
                    <p class="post-content" style="margin-bottom: 5px;">${post.contenido_publicacion.substring(0, 150)}...</p>
    ...
    // Cierra el diálogo de información personal con un retardo de 1 segundo
    ...
    // Cierra el diálogo de testimonios con un retardo de 1 segundo
    ...
    // Cierra el diálogo de publicaciones guardadas con un retardo de 1 segundo
    ...
    // Cierra el diálogo de MIS Publicaciones con un retardo de 1 segundo
